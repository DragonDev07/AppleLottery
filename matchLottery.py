...
print("Hello! Welcome to the Match Lottery. Please answer the questions below to get started.")
print("In this lottery the numbers that are drawn can be identical! For example, [2, 2]")
print("Remeber when you are picking your lottery numbers, they can be the same!")
print("~~~~~~~~~~~~~~~~~~~~~~~~~")
